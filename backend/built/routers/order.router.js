        ...
        switch (_a.label) {
            case 0:
                ...
                if (requestOrder.items.lenght <= 0) {
                    res.status(http_status_1.HTTP_BAD_REQUEST).json({ Alert: 'Order must contain at least one item' });
                    return [2 /*return*/];
                }
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (order)
                    ...
                    res.status(http_status_1.HTTP_BAD_REQUEST).json({ Alert: 'No new order found for current user' });
                return [2 /*return*/];
        }
    });
}); }));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                order = _a.sent();
                if (!order) {
                    res.status(http_status_1.HTTP_BAD_REQUEST).json({ Alert: 'No order found' });
                    return [2 /*return*/];
                }
                res.send(order);
                return [2 /*return*/];
