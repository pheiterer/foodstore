        ...
        switch (_c.label) {
            ...
            case 3:
                if (_b) {
                    ...
                    res.status(http_status_1.HTTP_UNAUTHORIZED).json({ Alert: 'Invalid email or password' });
                }
                return [2 /*return*/];
        }
    });
...
router.post('/register', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, address, userExists, encryptedPassword, user;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                res.status(http_status_1.HTTP_CONFLICT).json({ Alert: 'User already exists' });
                return [2 /*return*/];
